package io.agora.meeting.ui.http.network;
...
import io.agora.meeting.ui.http.callback.ThrowableCallback;
...
public class RetrofitManager {
    ...
    public static class Callback<T extends BaseResponse> implements retrofit2.Callback<T> {
        private int code;
        private io.agora.meeting.ui.http.callback.Callback<T> callback;

        public Callback(int code, @NonNull io.agora.meeting.ui.http.callback.Callback<T> callback) {
            this.code = code;
            ...
            if (response.errorBody() != null) {
                ...
                if (body == null) {
                    ...
                    if (!TextUtils.isEmpty(body.E)) {
                        throwableCallback(new HttpException(-1, body.E));
                    } else {
